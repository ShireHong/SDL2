...
//#include "config_attribute_value.h"
...
public:
	 ...
	 * containing @a value.
	 */
	// optional_config_impl<config> find_child(const std::string &name,
	// 	const std::string &value);

	// optional_config_impl<const config> find_child(const std::string &name,
	// 	const std::string &value) const
	// { return const_cast<config *>(this)->find_child(name, value); }
